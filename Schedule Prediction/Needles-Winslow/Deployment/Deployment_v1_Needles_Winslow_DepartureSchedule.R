...
ActualSchedule=  ActualSchedule[ActualSchedule$Departure_Date<=as.Date(temp-7,format = "%m/%d/%Y"),]
ActualSchedule=  ActualSchedule[ActualSchedule$Departure_Date>=as.Date(Active_startDate,format = "%m/%d/%Y"),]
...
train=train[with(train, order(Date,TS_Bucket)), ]
